...
import com.jonathanalvarez.webapp.biblioteca.service.PrestamoService;
...
public class PrestamoControllerView  implements Initializable{
    ...
    @FXML
    TextField tfId, tfVigencia;
    @FXML
    Button btnGuardar, btnLimpiar, btnRegresar, btnEliminar, btnAgregar;
    @FXML
